...
public class LightningKenoWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LightningKenoWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LightningKenoIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LightningKenoIW/InitOutcome.xml").getDocumentElement();
